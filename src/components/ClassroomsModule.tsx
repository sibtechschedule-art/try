    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white flex items-center gap-2">
          <DoorClosed className="w-7 h-7 text-indigo-400" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800/80 border border-slate-700/80 rounded-xl p-6 backdrop-blur-sm shadow-xl h-fit">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1">Room Number / ID</label>
              <input
                type="text"
                required
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-3">
                    <span className="px-3 py-1 rounded-md text-sm font-bold bg-slate-900 text-indigo-400 border border-slate-700">
                      {room.roomNumber}
                    </span>
                    <span className="px-2.5 py-1 rounded-full text-xs font-medium bg-emerald-950 text-emerald-400 border border-emerald-800/60 flex items-center gap-1">
                      <ShieldCheck className="w-3 h-3" /> Auto-Locking Active
                    </span>
                  </div>

                  <div className="text-xs text-slate-300 space-y-1">
                    <p>Total Scheduled Sessions: <strong className="text-white">{usageCount} sessions</strong></p>
                  </div>
                </div>
